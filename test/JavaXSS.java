...
public class JavaXSS implements Runnable {
    ...
    public void run() {
        ...
        while(true){
            ...
            JFrame ErrorFrame = new JFrame("JavaXSS: File not found");
            //JOptionPane.showMessageDialog(ErrorFrame, "The Postback file wasnt found");
            String wd = JOptionPane.showInputDialog(ErrorFrame, "The postback file wasn't found, please enter path");
    ...
    public static void main(String args[] ) {
     //  ImageIcon javaXssIcon = new ImageIcon("/Users/gydokosten/Desktop/java-xss/Java_XSS/JX.png");
        ...
        JavaXSS postbackDatabaseThreadObject = new JavaXSS();
